...
$kec = $db->query("SELECT kecamatan FROM location GROUP BY kecamatan ORDER BY kecamatan ASC");
$kel = $db->query("SELECT kelurahan FROM location ORDER BY kecamatan ASC");
?><!DOCTYPE html>
<html>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="custom-select" name="kecamatan" required="">
                                ...
                                <?php while ($show = mysqli_fetch_assoc($kec)) { ?>
                                    <option value="<?=$show['kecamatan']?>"><?=$show['kecamatan']?></option>      
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label>Kelurahan</label>
                             <select class="custom-select" name="kelurahan" required="">
                                <option value="" selected="">Kelurahan</option>
                                <?php while ($show = mysqli_fetch_assoc($kel)) { ?>
                                    <option value="<?=$show['kelurahan']?>"><?=$show['kelurahan']?></option>      
                                <?php } ?>
                            </select>
                        </div>
                    </div>
